...
void bitset_shift_left(bitset_t *bitset, size_t s)
{
    ...
    else
    {
        ...
        {
            bitset->array[i - 1] = (bitset->array[i - 1 - extra_words] << inword_shift) | (bitset->array[i - 2 - extra_words] >> (64 - inword_shift));
        }
...
void bitset_shift_right(bitset_t *bitset, size_t s)
{
    ...
    else
    {
        ...
        {
            bitset->array[i] = (bitset->array[i + extra_words] >> inword_shift) | (bitset->array[i + extra_words + 1] << (64 - inword_shift));
        }
