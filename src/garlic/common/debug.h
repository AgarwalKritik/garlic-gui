...
#define DEBUG_STACK_PRINT(FMT, ARGS...)         \
    do                                          \
    {                                           \
        if (DEBUG_STACK)                        \
            fprintf(stdout, "" FMT "", ##ARGS); \
...
#define DEBUG_GOTO_OPTIMIZE_PRINT(FMT, ARGS...) \
    do                                          \
    {                                           \
...
#define DEBUG_TERNARY_PRINT(FMT, ARGS...)       \
    do                                          \
    {                                           \
        if (DEBUG_TERNARY)                      \
            fprintf(stdout, "" FMT "", ##ARGS); \
...
#define DEBUG_EXCEPTION_PRINT(FMT, ARGS...)     \
    do                                          \
    {                                           \
        if (DEBUG_EXCEPTION)                    \
            fprintf(stdout, "" FMT "", ##ARGS); \
...
#define DEBUG_ERROR_PRINT(FMT, ARGS...)         \
    do                                          \
    {                                           \
        if (DEBUG_ERROR)                        \
            fprintf(stdout, "" FMT "", ##ARGS); \
...
#define DEBUG_ANNO_PRINT(FMT, ARGS...)          \
    do                                          \
    {                                           \
        if (DEBUG_ANNOTATION)                   \
            fprintf(stdout, "" FMT "", ##ARGS); \
