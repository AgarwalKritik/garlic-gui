...
string field_type_sig_to_s(field_type_sig *fts)
{
    ...
    case BASE_TYPE_SIGNATURE:
    {
        ...
        case 2:
            return str_dup(g_str_double);
        case 3:
            return str_dup(g_str_float);
        case 4:
            return str_dup(g_str_int);
        case 5:
            return str_dup(g_str_long);
        case 6:
            return str_dup(g_str_short);
        case 7:
            return str_dup(g_str_boolean);
        case 8:
            return str_dup(g_str_void);
        default:
